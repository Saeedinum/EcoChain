  ...
  return (
    <section className="relative flex flex-col items-center overflow-hidden pb-20 max-lg:gap-40 lg:flex-row lg:justify-between lg:px-[5rem] lg:pb-[15rem]">
      ...
      <img
        src={animation1Image}
        alt=""
        className="place-self-center max-lg:w-[325px] lg:hidden"
      />
      ...
      <div className="relative hidden h-[500px] w-[520px] lg:block">
        {images.map((image, index) => (
          <img
            ...
            src={image}
            alt=""
            className={`absolute w-full transform transition-all duration-1000 ${
      ...
      <img
        src={leftBackground}
        alt=""
        className="absolute left-0 top-0 -z-10 max-lg:w-[452px]"
      />
      <img
        src={rightBackground}
        alt=""
        className="absolute right-0 -z-10 max-lg:top-[400px] max-lg:w-[384px] lg:top-0"
      />
    </section>
  );
};
