  ...
  return (
    <main className="relative h-[100vh] w-full pt-20">
      ...
      <section className="flex w-full flex-col items-center justify-center gap-5 text-center">
        ...
        <p className="w-[30%] text-[15px] font-bold text-[#BABABA]">
          Lorem ipsum dolor sit amet consectetur. Risus eros tincidunt justo
          mauris nullam. Arcu ut nulla odio vitae viverra tincidunt.
        </p>
      </section>
        ...
        <nav className="grid grid-cols-5 flex-wrap items-center gap-[5rem] gap-y-4">
          {data.topics.map((topic) => (
            ...
            >
              <figure
                key={topic.id}
                className="flex h-[200px] cursor-pointer flex-col items-center justify-end gap-3 text-center"
              >
                <img
                  src={topic.logo}
                  alt={topic.title}
                ...
                />
                <figcaption className="font-vold text-nowrap text-[18px] font-bold">
                  {topic.title}
                </figcaption>
              </figure>
            </NavLink>
